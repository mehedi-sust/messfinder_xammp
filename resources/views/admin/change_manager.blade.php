...
<head>
    ...
    <!-- Custom CSS for adding member names -->
    <script src="js/change_manager.js"></script>
...
<body>
    ...
    <div class="container" id="form_container">
        <div class="content">
            <h3 class="page-header">Create New Manager</h3>
            <form class="form-inline">
            <!--
                <div class="form-group">
                    <select class="form-control" name="manager_name" id="manager_name">
                    <option>Raihan Ahmed</option>
                    <option>Mehedi Al-Hasan</option>
                    <option>Akib</option>
                    </select>
                </div>
                -->
